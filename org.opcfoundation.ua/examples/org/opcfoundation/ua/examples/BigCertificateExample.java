...
public class BigCertificateExample {
	...
	{        
		...
		PropertyConfigurator.configure( BigCertificateExample.class.getResource("log.properties") );
		// Create Logger
		Logger myLogger = Logger.getLogger( BigCertificateExample.class ); 
...
class MyServerExample2 extends Server implements MethodServiceSetHandler, SessionServiceSetHandler {
	...
	public MyServerExample2(Application application) throws CertificateException, IOException, UnrecoverableKeyException, NoSuchAlgorithmException, KeyStoreException, URISyntaxException, ServiceResultException, InvalidKeyException, InvalidKeySpecException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, InvalidParameterSpecException
	{
		super(application);
		...
		application.getHttpsSettings().setKeyPairs( new KeyPair[] {
				myServerHttpsKeyPair_1024,
				myServerHttpsKeyPair_2048,
				myServerHttpsKeyPair_4096,
				myServerHttpsKeyPair_8192, 
		}, caCerts );
