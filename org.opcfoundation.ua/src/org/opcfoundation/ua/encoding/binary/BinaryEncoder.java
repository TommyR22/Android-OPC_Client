...
public class BinaryEncoder implements IEncoder {
	private static Logger logger = Logger.getLogger(BinaryEncoder.class);
...
//		}
    ...
    throws EncodingException	
	{
		...
		putNodeId(null, v.getBinaryEncodeId());
		putSByte(null, 1);
...
//	}
	...
	{
		Class<IEncodeable> clazz = (Class<IEncodeable>) s.getClass();
		putNodeId(null, ctx.getEncodeableSerializer().getNodeId(clazz, EncodeType.Binary));		
		ctx.getEncodeableSerializer().putEncodeable(clazz, s, this);
	}
