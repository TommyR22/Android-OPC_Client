...
public class Client {
	...
	public static Client createClientApplication(KeyPair cert) {
		...
		if (cert != null) {
			String certApplicationUri = CertificateUtils.getApplicationUri( cert.certificate );
			if ( certApplicationUri != null ) application.setApplicationUri( certApplicationUri );
	...
	public Session createSession(SecureChannel channel,
		...
		if (filteredEndpoints.length == 0)
			throw new ServiceResultException(StatusCodes.Bad_SecurityModeRejected,
