 ...
 * 
 * Validation is evaluated once and the result is cached. 
 *
 */
public class CertValidatorTrustManager implements X509TrustManager {
	...
	Map<X509Certificate, Cert> NotAccepted = new HashMap<X509Certificate, Cert>();
	 ...
	 */
	synchronized Cert getOrAdd(X509Certificate c) throws CertificateEncodingException {
