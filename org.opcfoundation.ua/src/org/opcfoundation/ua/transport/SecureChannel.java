...
public interface SecureChannel extends RequestChannel {
	 ...
	 * @param settings
	 */
	void initialize(String connectUrl, TransportChannelSettings settings) throws ServiceResultException;
	 ...
	 * @param settings
	 */
	void initialize(TransportChannelSettings settings) throws ServiceResultException;
