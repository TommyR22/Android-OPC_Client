...
public class HttpsClientSecureChannel implements SecureChannel {
	...
	static Logger logger = Logger.getLogger(HttpsClientSecureChannel.class);
	...
	@Override
	public void initialize(String url, TransportChannelSettings tcs) throws ServiceResultException {
		client.initialize(url, tcs);		
	}

	@Override
	public void initialize(TransportChannelSettings tcs) throws ServiceResultException {
		client.initialize(tcs.getDescription().getEndpointUrl(), tcs);
	}
...
//			createSecureChannel(false);
	...
	public IEncodeable serviceRequest(ServiceRequest request) throws ServiceResultException {
		AsyncResult asyncResult = client.serviceRequestAsync(request, client.getTimeout(request), secureChannelId);
...
//	}
	...
	public ServiceMessageContext getMessageContext() {
		TransportChannelSettings settings = client.transportChannelSettings;
		if (settings==null) return null;
		ServiceMessageContext result = new ServiceMessageContext();
		result.setEncodeableSerializer( client.serializer );
