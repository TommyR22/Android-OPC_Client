...
public class HttpsServerEndpointHandler implements HttpAsyncRequestHandler<HttpRequest> {
	...
	/** Logger */
	private final static Logger logger = Logger.getLogger(HttpsServerEndpointHandler.class);		
	...
	public void handle(HttpRequest request, HttpAsyncExchange httpExchange, HttpContext context) throws HttpException, IOException {
    	...
    	if (logger.isDebugEnabled()) {
    		...
    		logger.debug("handle: " + connection + " context=" + connection.getContext() +": "+request);
    	}
    ...
    void handleMessage( HttpsServerPendingRequest pendingMessage ) {
		...
		if ( msg instanceof OpenSecureChannelRequest ) {
			try {
				...
				logger.info("Channel: " + e.getMessage());
