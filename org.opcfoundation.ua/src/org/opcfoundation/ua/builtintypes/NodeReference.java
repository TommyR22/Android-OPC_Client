...
public class NodeReference {
	...
	/**
	 * Create ComparableNodeId from NodeId using default NamespaceTable and default ServerTable
	 * 
	 * @param nodeId
	 * @return a new node reference
	 */
	...
	{
		return createFromNodeId(nodeId, NamespaceTable.getDefault(), ServerTable.DEFAULT); 
	}
