...
public class TestUserTokens extends StackTestBench {
	...
	public void testPfx() throws InvalidKeyException, InvalidKeySpecException,
	...
	public void testPemPrivKeyNoPassword() throws IOException, CertificateEncodingException, InvalidKeySpecException, NoSuchAlgorithmException  {
		keys.getPrivateKey().save(file);
		PrivKey privKey = PrivKey.load(file);
